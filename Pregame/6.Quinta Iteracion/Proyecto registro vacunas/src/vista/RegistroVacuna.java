...
public class RegistroVacuna extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gestión de vacunas");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!verificar()) {
            try {
                ...
                dto.setRegistrado(Integer.parseInt(jTextField2.getText()));
                dto.setSuministrado(0);
                dao.append(dto);
                actualizarTabla();
                limpiar();
    ...
    private void actualizarTabla() {
        try {
            ...
            for (int i = 0; i < lista.size(); i++) {
                ...
                matriz[i][2] = lista.get(i).getRegistrado() + "";
                matriz[i][3] = lista.get(i).getNumdosis() + "";
                matriz[i][4] = lista.get(i).getSuministrado() + "";
            }

            jTable1.setModel(new javax.swing.table.DefaultTableModel(
                    matriz,
                    new String[]{
                        "ID", "Nombre", "Dosis registradas", "Dosis disponible", "Dosis suministradas"
                    }
            ));
        } catch (Exception ex) {
