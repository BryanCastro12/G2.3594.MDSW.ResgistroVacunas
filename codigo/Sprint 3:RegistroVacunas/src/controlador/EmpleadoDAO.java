...
public class EmpleadoDAO extends ConexionBD {
    ...
    private static final String SQL_INSERT = "Insert into Empleado " + "(" + cedula + "," + nombre + "," + apellido + "," + password + ") VALUES (?,?,?,?)";
    ...
    public void delete(EmpleadoDTO dto) throws SQLException {
        PreparedStatement ps = null;
