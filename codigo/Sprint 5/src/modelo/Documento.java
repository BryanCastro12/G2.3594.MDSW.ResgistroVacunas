...
//"ID", "Cedula", "Nombre", "Edad", "Tipo vacuna", "N dosis suministrada", "correo", "Telefono", "Fecha de registro"
            ...
            columnHeader = new PdfPCell(new Phrase("Tipo vacuna"));
            columnHeader.setHorizontalAlignment(Element.ALIGN_CENTER);
            table.addCell(columnHeader);
            
            columnHeader = new PdfPCell(new Phrase("N dosis suministrada"));
            columnHeader.setHorizontalAlignment(Element.ALIGN_CENTER);
            table.addCell(columnHeader);
            
            columnHeader = new PdfPCell(new Phrase("Correo"));
            columnHeader.setHorizontalAlignment(Element.ALIGN_CENTER);
            table.addCell(columnHeader);
            
            columnHeader = new PdfPCell(new Phrase("Telefono"));
            columnHeader.setHorizontalAlignment(Element.ALIGN_CENTER);
            table.addCell(columnHeader);
            
            columnHeader = new PdfPCell(new Phrase("Fecha de registro"));
            columnHeader.setHorizontalAlignment(Element.ALIGN_CENTER);
            table.addCell(columnHeader);
...
// Fill table rows (rellenamos las filas de la tabla).  
            ...
            for (int row = 0; row < lista.size(); row++) {
                ...
                table.addCell(lista.get(contador).getCedula());
                table.addCell(lista.get(contador).getNombrePersona());
                table.addCell(lista.get(contador).getEdad() + "");
                table.addCell(lista.get(contador).getVacuna());
                table.addCell(lista.get(contador).getNumDosis() + "");
                table.addCell(lista.get(contador).getCorreo());
                table.addCell(lista.get(contador).getTelefono());
                table.addCell(lista.get(contador).getFecha());
                contador++;
            }
...
// Fill table rows (rellenamos las filas de la tabla).                
            ...
            columnHeader = new PdfPCell(new Phrase("Dosis Registradas"));
            columnHeader.setHorizontalAlignment(Element.ALIGN_CENTER);
            table.addCell(columnHeader);
            
            columnHeader = new PdfPCell(new Phrase("Cantidad disponible"));
            columnHeader.setHorizontalAlignment(Element.ALIGN_CENTER);
            table.addCell(columnHeader);
            
            columnHeader = new PdfPCell(new Phrase("Cantidad suministrada"));
            columnHeader.setHorizontalAlignment(Element.ALIGN_CENTER);
            table.addCell(columnHeader);
...
// Fill table rows (rellenamos las filas de la tabla).  
            ...
            for (int row = 0; row < lista.size(); row++) {
                ...
                table.addCell(lista.get(contador).getRegistrado()+"");
                table.addCell(lista.get(contador).getNumdosis() + "");
                table.addCell(lista.get(contador).getSuministrado()+ "");
                contador++;
            }
// We add the table (Añadimos la tabla)
            paragraphMore.add(table);
