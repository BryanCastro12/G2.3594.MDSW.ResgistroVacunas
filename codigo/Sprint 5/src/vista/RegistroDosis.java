            ...
            if (verificarCorreo()) {
                if (isEcuadorianDocumentValid(cedulaText.getText())) {
                    try {
                        ...
                        dto.setFecha(fecha);
                        dao.append(dto);
                        //Se quita -1 a la cantida de vacunas
                        VacunaDAO dao = new VacunaDAO();
                        VacunaDTO encontrado = dao.search(vacunaBox.getSelectedItem().toString());
                        ...
                        Logger.getLogger(RegistroDosis.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
